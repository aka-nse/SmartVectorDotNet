...
{
    private static double[] IEEE754Specials { get; }
        =new []
        {
            0.0,
            -0.0,
    ...
    public static IEnumerable<object[]> UnaryOperatorTestCases()
    {
        ...
        yield return core(IEEE754Specials);
        yield break;
    }
    ...
    {
        {
            ...
            AccuracyAssert.Accurate(x, exp, act, 1e-10, AccuracyMode.AbsoluteOrRelative);
        ...
        }
        {
            ...
            AccuracyAssert.Accurate(null, exp, act, 1e-5f, AccuracyMode.AbsoluteOrRelative);
    ...
    public void Test_UnaryPlus_real(double[] x)
    {
        ...
        }
        {
            ...
            AccuracyAssert.Accurate(xx, exp, act, 1e-5f, AccuracyMode.AbsoluteOrRelative);
        }
    }
