...
internal sealed class FloatNumberComparer : IEqualityComparer<double>, IEqualityComparer<float>
{
    public static FloatNumberComparer Instance { get; } = new ();
    private FloatNumberComparer() { }
