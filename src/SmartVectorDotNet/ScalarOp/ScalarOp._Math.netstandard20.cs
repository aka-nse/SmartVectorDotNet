...
namespace System
{
    internal static class MathF
    {
        ...
        public static float Acosh(float  d) => MathF.Acosh(d);
        public static float Asinh(float  d) => MathF.Asinh(d);
        public static float Atanh(float  d) => MathF.Atanh(d);
        public static float Cbrt(float  d) => MathF.Cbrt(d);
#else
