...
internal static class PopulationPoC
{
    ...
    private static bool TestPopulation_Byte()
    {
        ...
        {
            if (ScalarMathRefImpl.Population(testValue) != ScalarMathPoC.Population(testValue))
            {
                return false;
            }
        }
...
file static class ScalarMathRefImpl
{
    public static int Population(byte x)
    {
        var n = 0;
    ...
    public static int Population(ushort x)
    {
        var n = 0;
    ...
    public static int Population(uint x)
    {
        var n = 0;
    ...
    public static int Population(ulong x)
    {
        var n = 0;
